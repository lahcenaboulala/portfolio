			...
			<div class="row">
				<div class="col-lg-4 d-flex flex-column address-wrap">
					...
					<div class="single-contact-address d-flex flex-row">
						...
						<div class="contact-details">
							<h5>lahcen.tri@gmail.com</h5>
							<p>Send us your query anytime!</p>
						</div>
					</div>
				</div>
				<div class="col-lg-8">
					<form class="form-area " id="my Form" action="email.php" method="post" class="contact-form text-right">
						<div class="row">
							...
							<div class="col-lg-12">
								...
								<!--<input type="submit" name="submit">-->
								 <button class="primary-btn" type="submit" name="submit" style="float: right;" data-text="Send Message">
									<span>S</span>
									<span>e</span>
									<span>n</span>
									<span>d</span>
				...
				<div class="col-lg-12">
					<div class="footer-top flex-column">
						...
						<div class="footer-social">
							...
							<a href="https://twitter.com/lahcen_tri"><i class="fa fa-twitter"></i></a>
							<a href="http://www.viadeo.com/p/0022ctbj9o1h78a"><i class="fa fa-viadeo"></i></a>
							<a href="#"><i class="fa fa-linkdin-in"></i></a>
						</div>
					</div>
				</div>
			</div>
